...
$checkStatistic = "SELECT * FROM navstevnost stat WHERE stat.id = 4";
$resultStatistic = $conn->query($checkStatistic);
if($rowStatistic = $resultStatistic->fetch_assoc()){
    $checkStatistic = $rowStatistic["count"] + 1;
    $statistic = "UPDATE navstevnost stat SET stat.count = '$checkStatistic' WHERE stat.id = 4";
}

if(isset($_POST['submit'])){
	$r = $_POST['r'];
	$sql = "UPDATE vstup SET lietadlo='$r' WHERE id=1";
	$conn->query($sql);
}
  ...
  margin-bottom: 100pxô
	...
	<div id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
		...
		<form method="post" action="naklon.php">
		...
		<div id="animacia"><p class="d"><b>Posielané dáta</b></p>
	...
	var stream = null;
            ...
            var url = "http://147.175.121.210:8168/skuska/server4.php";
